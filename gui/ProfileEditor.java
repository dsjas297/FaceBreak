...
public class ProfileEditor extends JPanel{
	...
	public ProfileEditor(int wall_width, JButton s_e){
		...
		names.setMinimumSize(new Dimension(220, 40));
		names.setMaximumSize(new Dimension(220, 40));
		
		JPanel status = new JPanel();
		status.setLayout(new BoxLayout(status, BoxLayout.LINE_AXIS));
		status.setMinimumSize(new Dimension(220, 40));
		status.setMaximumSize(new Dimension(220, 40));
		...
		fname_panel.setMinimumSize(new Dimension(100, 40));
		fname_panel.setMaximumSize(new Dimension(100, 40));
		...
		lname_panel.setMinimumSize(new Dimension(100, 40));
		lname_panel.setMaximumSize(new Dimension(100, 40));
		...
		titleEntry = new JTextField(8);
		title_panel.setMinimumSize(new Dimension(100, 40));
		title_panel.setMaximumSize(new Dimension(100, 40));
		...
		fam_panel.setMinimumSize(new Dimension(100, 40));
		fam_panel.setMaximumSize(new Dimension(100, 40));
		...
		img_panel.setMinimumSize(new Dimension(wall_width, 50));
		img_panel.setMaximumSize(new Dimension(wall_width, 50));
