...
public enum Error {
	...
	LOGGEDIN_USER(12, "There is a user already logged in."),	// giving out too much information?
	MSG_INTEGRITY(13, "Cannot complete request; message corrupted. Please log out and log back in."),	// if message fails checksum, possibly changed by man in middle
	UNKNOWN_ERROR(14, "Unknown error occurred."); // does this mean anything?
